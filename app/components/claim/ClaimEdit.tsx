...
export const ClaimEdit = ({ claim: claimDb }: ClaimGetByIdSuccess) => {
  ...
  const [imagePreviewUrl, setImagePreviewUrl] = useState<{
    ...
    image2:
      claimDb.image2 && claimDb.image2 != "" ? claimDb.image2 : "/no_image.jpg",
    image3:
      claimDb.image3 && claimDb.image3 != "" ? claimDb.image3 : "/no_image.jpg",
    image4:
      claimDb.image4 && claimDb.image4 != "" ? claimDb.image4 : "/no_image.jpg",
    image5:
      claimDb.image5 && claimDb.image5 != "" ? claimDb.image5 : "/no_image.jpg",
    image6:
      claimDb.image6 && claimDb.image6 != "" ? claimDb.image6 : "/no_image.jpg",
    image7:
      claimDb.image7 && claimDb.image7 != "" ? claimDb.image7 : "/no_image.jpg",
  });
  ...
  const resetImage = (imageName: string) => {
    setImagePreviewUrl({ ...imagePreviewUrl, [imageName]: "/no_image.jpg" });
    setClaim({ ...claim, [imageName]: "" });
  };
  ...
  return (
    <div className="custom-container">
      {isBlurred && <div className="overlay"></div>}
      <div className={isBlurred ? "blur-container" : ""}>
        ...
        {loadingState ? (
          ...
          >
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6">
                <div className="form-group">
                  <label htmlFor="date_of_fixing">
                    Дата устранения провала
                  </label>
                  <input
                    name="date_of_fixing"
                    type="date"
